"""
FNO for PDEBench 1D Advection (beta=1.0) — Autoregressive Rollout
==================================================================
Based on working test_1 approach: predict one timestep at a time,
feed prediction back as input. Enhanced architecture to beat 5.9e-3.

Key: uses pdebench/Advection HF repo + autoregressive training.
"""
...
app = modal.App("fno-advection-pdebench")
volume = modal.Volume.from_name("fno-advection-results", create_if_missing=True)
...
def train_all():
    ...
    test_loader = DataLoader(
        AdvDS(data_t[N_TRAIN : N_TRAIN + N_TEST], grid_t, INIT_STEP),
        batch_size=BATCH,
        shuffle=False,
        num_workers=2,
        pin_memory=True,
